...
package com.derpdeveloper.blackscreenoflife.billingutil;
...
public class IabHelper {
    ...
    void flagEndAsync() {
        ...
        else logDebug("Ending async operation: null");
        mAsyncOperation = "";
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        //validacao DD porque estava a dar algumas excepcoes no ACRA
        if(mContext == null)
    ...
    // Adicionado para ver se ja nao da erro de setup
